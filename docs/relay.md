...
1. You enable a public link from the agent's **Connections → Network** settings
...
1. Open the Management window (`⌘ ⇧ M`) → **Agents**, choose the agent, then open **Connections → Network**
