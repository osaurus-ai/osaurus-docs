...
description: Osaurus ships App Intents, so "Ask Osaurus" and "Run Osaurus Agent" work system-wide the moment you install — from Shortcuts, Spotlight, and Siri, with zero setup.
---
